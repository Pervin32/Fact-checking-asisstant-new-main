// React və lazımi komponentləri idxal edirik
...
const Main = () => {
    // Prinsiplərimiz bölməsinə scroll üçün ref yaradırıq
    ...
    return (
        <div>
            ...
            {/* Prinsiplərimiz bölməsi üçün hədəf element */}
