    ...
    return (
        <div className='font-poppins font-semibold'>
            <section id='prinsiplərimiz'>
                <h1 className='text-blue font-semibold text-3xl md:text-5xl mb-5 text-center md:text-start'>Prinsiplərimiz</h1>
            </section>
