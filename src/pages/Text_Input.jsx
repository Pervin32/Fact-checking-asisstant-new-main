...
const TextInput = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      // Store current search text for result page
      ...
      // Store result data in localStorage for Loading component to access
      localStorage.setItem('apiResponse', JSON.stringify({
        searchText,
      ...
      // Navigation to result page will be handled by Loading component
    } catch (error) {
