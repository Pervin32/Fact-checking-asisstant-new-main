...
import { BeatLoader, ClipLoader, FadeLoader, PulseLoader } from 'react-spinners';
...
const getScoreDescription = (score) => {
    if (score >= 80) return 'Məqalə yüksək dərəcədə etibarlı, faktlarla dəstəklənmiş və güvəniləndir.';
    if (score >= 60) return 'Məqalə əsasən etibarlıdır, amma bəzi mənbələr tam dəqiq deyil və ya yoxlanmalı mənbələr var.';
    if (score >= 40) return 'Məqalə şübhəlidir və məlumatların etibarlılığı orta səviyyədədir.';
    return 'Məqalə qeyri-etibarlıdır və saxta xəbərlərə bənzər ola bilər.';
};
            ...
            <div className="flex flex-col min-h-full">
                ...
                {isLoading && (
                        <div className="flex items-center justify-center mt-4">
                            <PulseLoader size={35} color="#4BDB2B" />
                        </div>
                    )}
                    {error && (
                    ...
                    <div className="mb-8 md:mb-12 mt-[30px] md:mt-[53px] flex flex-col justify-center items-center text-center">
                        ...
                        <p className={`text-sm md:text-base mt-2 max-w-[600px] mx-auto ${getCategoryScore(score)}`}>
